...
#ifndef LADREMOTE_SWIFT_H
#define LADREMOTE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LADRemote",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9LADRemote12BridgeEngine")
...
@interface BridgeEngine (SWIFT_EXTENSION(LADRemote)) <WKScriptMessageHandler>
...
SWIFT_CLASS("_TtC9LADRemote15RelayConnection")
@interface RelayConnection : NSObject
...
@interface RelayConnection (SWIFT_EXTENSION(LADRemote)) <NSURLSessionWebSocketDelegate>
